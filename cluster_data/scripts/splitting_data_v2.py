...
def main():
	...
	print("Number of samples for training: "+str(length_total*0.85))
	print("Number of samples for validation: "+str(length_total*0.15))
	...
	for label in labels:
		...
		X_train, X_val, y_train, y_val = train_test_split(df_labels["annotation"],df_labels[label],test_size=0.15)
